    ...
    return [
        {
            ...
            "item_quantity": int(purchase_order_data[i]["item_quantity"]),
            "item_unit_price": float(purchase_order_data[i]["item_unit_price"]),
            ...
            "agreed_delivery_location_id": int(
                purchase_order_data[i]["agreed_delivery_location_id"]
            ),
        }
