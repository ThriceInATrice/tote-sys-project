-- project_team_1 dim_counterparty    table postgres
--  project_team_CREATE TABLE IF NOT EXISTS 1 dim_currency        table postgres
--  project_team_1CREATE TABLE IF NOT EXISTS  dim_date,            table postgres
--  project_team_1CREATE TABLE IF NOT EXISTS  dim_design          table postgres
--  project_team_1CREATE TABLE IF NOT EXISTS  dim_location        table postgres
--  project_team_1CREATE TABLE IF NOT EXISTS  dim_payment_type    table postgres
--  project_team_1CREATE TABLE IF NOT EXISTS  dim_staff           table postgres
--  project_team_1CREATE TABLE IF NOT EXISTS  dim_transaction     table postgres
--  project_team_1CREATE TABLE IF NOT EXISTS  fact_payment        table postgres
--  project_team_1 fact_purchase_order table postgres
--  project_team_1 fact_sales_order    table postgres
