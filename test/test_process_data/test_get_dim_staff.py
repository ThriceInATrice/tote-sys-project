from src.process_data.get_dim_staff import get_dim_staff, DBCredentialsExportError, UnexpectedDimStaffError
import os
import pytest
import re
...
def test_get_dim_staff_raises_error_when_db_credentials_not_exported():
    ...
    with pytest.raises(DBCredentialsExportError, match=re.escape("Please enter export DB_CREDENTIALS_ID=[Your database credentials ID] into terminal.")):
...
def test_get_dim_staff_raises_error_with_incorrect_db_credentials_exported():
    ...
    with pytest.raises(DBCredentialsExportError, match=re.escape("Incorrect Credentials ID: Please export DB_CREDENTIALS_ID=[Your database credentials ID] into terminal.")):
